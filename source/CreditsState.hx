...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['placeholder that i copypasted'],
			['ur mom',		'shadowmario',		'Main Programmer of ur mom.com',						'https://twitter.com/Shadow_Mario_',	'444444'],
			['ur father',			'riveroaken',		'Main Artist/Animator of ur mom',					'https://twitter.com/river_oaken',		'C30085'],
			['barack obama',				'obama',			'President of the United Zones of America',		'https://twitter.com/yoshubs',			'4494E6'],
			[''],
			['Psych Engine Team'],
